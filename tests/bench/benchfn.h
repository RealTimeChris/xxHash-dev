...
typedef struct {
	...
	BMK_benchFn_t benchPayload; /* pass custom parameters to benchFn  :
	...
	void** dstBuffers; /* array of buffers to be written into by benchFn. This array is not optional, it must be provided even if unused by benchfn. */
