...
inline UniHash chrishendo_wrapper(const void* src, size_t srcSize)
{
    return uniHash64(hasher.hashKeyRt(static_cast<const char*>(src), srcSize));
}
